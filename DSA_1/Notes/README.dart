...
Linear DataStructure:- 
  ...
  Q. What is Two Dimensional array?
      A 2D array, or two-dimensional array, is an array of arrays, where 
  ...
  Q. What is meant by subarrays?
      ...
      without changing their order.
        ...
        Example:- 
         ...
         programming, you may need to examine or manipulate various subarrays 
         of an array.
  ...
  Q. What is meant by holes in an array?
      ...
      --> Holes in an array can occur in various scenarios:
          # Uninitialized elements:
               If you create an array without initializing all its elements 
          ...
          # Deletion or removal of elements:
            ...
            For Example:- 
                For example, in languages like C or C++, if you delete an 
...
step 4:- while i is lessthan or equalto n do the following
...
Program:-
  ...
  ===========================================================================
    ...
    Q. What are the types of Linked List?
        The Linked List is of two types such as 
